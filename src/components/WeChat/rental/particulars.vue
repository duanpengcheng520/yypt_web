<template>
 <el-dialog :visible.sync="dialogVisible" custom-class="w-900 h-380 ovf-auto" title="订单详细信息" center>
        ...
        <el-tab-pane label="商品清单">
              <el-row>
                <el-col :span="8"><div class="grid-content bg-purple">商品名称：{{rowData.snapshoot.sku_name}}</div></el-col>
                <el-col :span="8"><div class="grid-content bg-purple-light">型号:</div></el-col>
                <el-col :span="8"><div class="grid-content bg-purple">商品价格:</div></el-col>
                <el-col :span="8"><div class="grid-content bg-purple">优惠信息:{{rowData.snapshoot.name}}</div></el-col>
                <el-col :span="8"><div class="grid-content bg-purple">运费:</div></el-col>
...
<script>
  ...
  export default {
    ...
    created() {
        ...
        //this.getParticulars()
        console.log(this.rowData.snapshoot)

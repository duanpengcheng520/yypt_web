        ...
        <template scope="scope">
          <div>
            ...
            <span v-if="scope.row.status=='paid'">
              <router-link :to="{ name: 'weChatRentaShipments', params: { param: {orderid:scope.row.id,st:scope.row.snapshoot} }}" class="btn-link edit-btn">
                待发货
              </router-link>
            </span>
            <span v-if="scope.row.status=='shippend'">
              <router-link :to="{ name: 'Print', params: { param: scope.row }}" class="btn-link edit-btn">
                打印
              </router-link>
 ...
 export default {
    ...
    methods: {
      ...
      openParticulars(row){
          ...
          this.formInline.rowData.snapshoot=_g.s2j(this.formInline.rowData.snapshoot);
          console.log(this.formInline.rowData.snapshoot);
    ...
    　　　　})
      ...
      getAllOder() {
        ...
        this.apiGet('weChat/rentalOder/', data).then((res) => {

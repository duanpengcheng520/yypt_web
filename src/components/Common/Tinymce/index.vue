...
export default {
  ...
  props: {
    ...
    toolbar: {
      ...
      required: false,
      default() {
        return ['removeformat undo redo |  bullist numlist | outdent indent | forecolor | fullscreen code', 'bold italic blockquote | h2 p image media link | alignleft aligncenter alignright']
      }
    },
    menubar: {
      default: ''
